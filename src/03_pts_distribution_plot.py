...
plt.hist(pts_values, bins=20, color='red', edgecolor='black', alpha=0.7)

# Lignes rouges pointillées pour indiquer les bornes [10, 25]
plt.axvline(x=10, color='yellow', linestyle='--', linewidth=2)
plt.axvline(x=25, color='yellow', linestyle='--', linewidth=2)
